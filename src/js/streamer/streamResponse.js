import { renderSourcesList } from '../chat/sourceCards.js';
...
export async function streamResponse(formData, originalMessage) {
    ...
    cursorEl.className = 'streaming-cursor text-cyan-400 font-bold ml-0.5 select-none inline-block';
                    ...
                    try {
                        ...
                        if (event === 'scraping_done') {
                            ...
                            if (row) {
                                ...
                                const existingSpinner = row.querySelector('.ui-spinner, .uk-spinner');
                        ...
                        if (event === 'consolidation_start') {
                            ...
                            if (!consolidatingBadge && aiLabelContainer) {
                                ...
                                consolidatingBadge.innerHTML = '<span class="ui-spinner" aria-hidden="true"></span> Consolidating evidence...';
